    ...
    return(
        <div className='bg-gray-light flex flex-col gap-3 h-full'>
            <div className='fixed top-0 w-full bg-white z-10'>
                <Header type='CourseTrading' setSearchValue={setSearchValue} searchValue={searchValue} filterValue={filterValue} setFilterValue={setFilterValue}/>
            ...
            <div className='w-full max-w-screen-lg h-full'>
                    <Feed type='CourseTrading' searchValue={searchValue} filterValue={filterValue} />
                </div>
            </div>
        </div>
    );
